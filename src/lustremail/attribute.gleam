...
///
pub fn closedby(value: String) -> Attribute {
...
///
pub fn command(value: String) -> Attribute {
...
/// The attribute is supported by the `<button>` element.
/// 
pub fn commandfor(value: String) -> Attribute {
...
///
pub fn srcset(sources: String) -> Attribute {
...
///
pub fn accept_charset(charsets: String) -> Attribute {
...
///
pub fn enctype(encoding_type: String) -> Attribute {
...
///
pub fn method(http_method: String) -> Attribute {
...
///
pub fn novalidate(disable_validation: Bool) -> Attribute {
...
/// > type.
///
pub fn accept(values: List(String)) -> Attribute {
...
/// - `"color"`
///
pub fn alpha(allowed: Bool) -> Attribute {
...
/// - `"color"`
///
pub fn colorspace(value: String) -> Attribute {
...
/// - `"url"`
///
pub fn dirname(direction: String) -> Attribute {
...
///
pub fn form(id: String) -> Attribute {
  attribute("form", id)
}
...
/// - `"submit"`
///
pub fn formaction(url: String) -> Attribute {
...
/// - `"submit"`
///
pub fn formenctype(encoding_type: String) -> Attribute {
...
/// - `"submit"`
///
pub fn formmethod(method: String) -> Attribute {
...
/// - `"submit"`
///
pub fn formnovalidate(no_validate: Bool) -> Attribute {
...
/// - `"submit"`
///
pub fn formtarget(target: String) -> Attribute {
...
/// - `"week"`
///
pub fn list(id: String) -> Attribute {
  attribute("list", id)
}
...
/// - `"url"`
///
pub fn maxlength(length: Int) -> Attribute {
...
/// - `"url"`
///
pub fn minlength(length: Int) -> Attribute {
...
/// - `"file"`
///
pub fn multiple(allow_multiple: Bool) -> Attribute {
...
/// - `"submit"`
///
pub fn popovertarget(id: String) -> Attribute {
...
/// - `"submit"`
///
pub fn popovertargetaction(action: String) -> Attribute {
...
/// - `"url"`
///
pub fn size(value: String) -> Attribute {
...
///
/// > **Note**: Lustremail's runtime augments this attribute. Whenever it is toggled
/// > to true, the media will begin playing as if the element's `play()` method
/// > was called.
///
pub fn autoplay(auto_play: Bool) -> Attribute {
...
///
pub fn controls(show_controls: Bool) -> Attribute {
...
///
pub fn muted(is_muted: Bool) -> Attribute {
...
///
pub fn playsinline(play_inline: Bool) -> Attribute {
...
///
pub fn poster(url: String) -> Attribute {
...
///
/// > **Note**: if you are pre-rendering a Lustremail component you must make sure this
...
///
pub fn shadowrootmode(mode: String) -> Attribute {
...
///
pub fn shadowrootdelegatesfocus(delegates: Bool) -> Attribute {
...
/// cloned.
///
pub fn shadowrootclonable(clonable: Bool) -> Attribute {
...
///
pub fn shadowrootserializable(serializable: Bool) -> Attribute {
...
///
pub fn aria_activedescendant(id: String) -> Attribute {
